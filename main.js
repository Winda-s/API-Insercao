    ...
    .on("data", async (data) => {
      ...
      if (HABILITAR_OPERACAO_INSERIR) {
        ...
        await poolBancoDados.execute(
          ...
          "INSERT INTO medida (valorChave, dht11_umidade, dht11_temperatura) VALUES (?, ?, ?)",
          // Estruturar dados atraves de lista
          [chave, dht11Umidade, dht11Temperatura],
        );
...
(async () => {
  ...
  await serial(valoresChave, valoresDht11Umidade, valoresDht11Temperatura);
